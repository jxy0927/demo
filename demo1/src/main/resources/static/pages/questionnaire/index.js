          ...
          <div class="list">
            <div class="list-header">
              ...
              <div>
                ...
                <button type="button" class="btn btn-link" onclick="selectQuestionnaire('${item.id}')">统计</button>
              </div>
            </div>
...
const selectQuestionnaire = (id) => {
  $util.setPageParam('showQuestionnaireWrited', id)
  //console.log('--',id)
  location.href = "/pages/showQuestionnaireAnswer/index.html"

}
const onCreateQuestionnaire = (id,projectName) => {
  $util.setPageParam('projectName', projectName)
  $util.setPageParam('projectId', id)
  console.log('---',id)
...
const onSeeProject = (id) => {
  ...
  let number=$util.getPageParam('Number')
